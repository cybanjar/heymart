 ...
 <form class="form form-horizontal" data-toggle="validator" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      ...
      <br><div class="tampil-logo" name="logo"></div>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      ...
      <br><div class="tampil-kartu" name="kartu_member"></div>
    </div>
  </div>

  <div class="form-group">
    <label for="sertifikat" class="col-md-2 control-label">Desain Sertifikat</label>
    <div class="col-md-4">
      <input id="sertifikat" type="file" class="form-control" name="sertifikat">
      <br><div class="tampil-sertifikat"  name="sertifikat"></div>
    </div>
  </div>
...
function showData(){
  $.ajax({
    ...
    success : function(data){
      ...
      $('.tampil-sertifikat').html('<img src="public/images/'+data.sertifikat+'?'+d.getTime()+'" width="300">');
    },
    error : function(){
      alert("Tidak dapat menyimpan data!");
    }   
