  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      @if( Auth::user()->level == 1 )
        ...
        <li><a href="{{ route('setting.index') }}"><i class="fa fa-gears"></i> <span>Pengaturan</span></a></li>
      @else
        <li><a href="{{ route('produkdetail.index') }}"><i class="fa fa-cubes"></i> <span>Produk</span></a></li>
        <li><a href="{{ route('pembelian_kasir.index') }}"><i class="fa fa-download"></i> <span>Pembelian Produk</span></a></li>
        ...
        <li><a href="{{ route('riwayat.index') }}"><i class="fa fa-history"></i> <span>Riwayat Transaksi</span></a></li>
